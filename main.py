...
bo_lsa_n_dimensions = Categorical([64,128, 256, 512], name='bo_lsa_n_dimensions')
...
def fitness(bo_lsa_n_features, bo_lsa_n_dimensions, 
    ...
    global iteration, num_steps, lstm_size, init_epoch, max_epoch, learning_rate_decay, dropout_rate, init_learning_rate, batch_size, kd_id_mask, ys, logs_file_ptr
    ...
    #x_train = prep_all_feats(kg_id_mask, lsa_n_features, lsa_n_dimensions, split = 'train') 
    ...
    x_dev = prep_all_feats(kg_id_mask, lsa_n_features, lsa_n_dimensions,  split = 'dev') 
    ...
    if do_test:
        ...
        x_test = prep_all_feats(kg_id_mask, lsa_n_features, lsa_n_dimensions,  split = 'test') 
...
if __name__ == "__main__":
    #CLEAN UP
    for f in os.listdir("temp_berts/"):
        os.remove("temp_berts/"+f)
